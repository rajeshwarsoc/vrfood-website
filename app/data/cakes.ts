...
export const CAKE_CATEGORIES: CakeCategory[] = [
  { id: "kids", name: "Детские торты", image: "https://images.unsplash.com/photo-1558636508-e0db3814bd1d?w=800" },
  {
    id: "characters",
  ...
  { id: "men", name: "Торты для мужчин", image: "https://images.unsplash.com/photo-1578985545062-69928b1d9587?w=800" },
  {
    id: "women",
    name: "Торты для женщин",
    image: "https://images.unsplash.com/photo-1606890737304-57a1ca8a5b62?w=800",
  },
  { id: "berry", name: "Ягодные торты", image: "https://images.unsplash.com/photo-1565958011703-44f9829ba187?w=800" },
  { id: "bento", name: "Бенто торты", image: "https://images.unsplash.com/photo-1621303837174-89787a7d4729?w=800" },
  { id: "open", name: "Открытый торт", image: "https://images.unsplash.com/photo-1571115177098-24ec42ed204d?w=800" },
  {
    id: "holiday",
...
export const CAKE_WEIGHTS = [2, 3, 4, 5];
